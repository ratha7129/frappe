      ...
      typeof navigator === "object" && function(global2, factory) {
        ...
        var RangeTouch = function() {
          ...
          return _createClass(e, [{
            ...
            key: "set",
            value: function(t) {
              e.enabled && is$1.event(t) && !t.target.disabled && (t.preventDefault(), t.target.value = this.get(t), trigger(t.target, t.type === "touchend" ? "change" : "input"));
            }
          }], [{
            key: "setup",
            value: function(t) {
        ...
        const support = {
          ...
          check(type, provider, playsinline) {
            ...
            const ui2 = api && support.rangeInput && (type !== "video" || !browser.isIPhone || canPlayInline);
            return {
              api,
              ui: ui2
            };
...
//# sourceMappingURL=video_player.bundle.5NDHKKAB.js.map
