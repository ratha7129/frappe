    ...
    make_filters() {
      ...
      frappe.call("frappe.website.doctype.web_form.web_form.get_web_form_filters", {
        ...
        fields.forEach((field) => {
          ...
          $(input.wrapper).addClass("col-md-2").attr("title", __(field.label)).tooltip({
  ...
  frappe.ui.WebFormListRow = class WebFormListRow {
    ...
    make_row() {
      ...
      this.columns.forEach((field) => {
        ...
        let value = this.doc[field.fieldname] && __(formatter(this.doc[field.fieldname], field, { only_value: 1 }, this.doc)) || "";
  ...
  frappe.ready(function() {
    ...
    function setup_fields(web_form_doc2, doc_data) {
      web_form_doc2.web_form_fields.forEach((df) => {
        df.is_web_form = true;
        df.read_only = !web_form_doc2.is_new && !web_form_doc2.is_form_editable;
...
//! version : 0.5.28
//! version : 2.29.4
//# sourceMappingURL=web_form.bundle.UDLI7PIN.js.map
